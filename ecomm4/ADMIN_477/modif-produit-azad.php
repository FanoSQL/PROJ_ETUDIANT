...
//print "B IdProduit = ".$IdProduit."<br>";
    ...
    //---THEORIE A et B ?
    $SQL_UPDATE = "UPDATE produit SET `LibelleProduit`='$Libelle', `DescriptionProduit`='$Description', `Prix`='$PrixTTC', `Enstock`='$Stock' WHERE `Id_Produit`='$IdProduit'";
    
    $SQL_UPDATE = "UPDATE `produit` SET `LibelleProduit`='[value-2]',`DescriptionProduit`='[value-3]',`Prix`='[value-4]',`Photo`='[value-5]',`Enstock`='[value-6]' WHERE `Id_Produit`='$IdProduit'";
